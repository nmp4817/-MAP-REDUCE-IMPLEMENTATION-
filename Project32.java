...
public class Project32
{
	public static class Mapper1 extends Mapper<LongWritable,Text,Text,ArrayWritable>
	{
	 ...
	 public static class Reducer1 extends Reducer<Text,ArrayWritable,Text,ArrayWritable>
	 {
		  @Override 
	...
	public static class Mapper2 extends Mapper<LongWritable,Text,Text,ArrayWritable>
	{
	 ...
	 public static class Reducer2 extends Reducer<Text,ArrayWriteable,Text,ArrayWritable>
	 {
		  @Override 
		  public void reduce(Text key, Iterable<ArrayWritable>values, Context c) throws IOException,InterruptedException
		  {
	...
	{ 
            ...
            Job j1 = new Job(conf); 
     	    j1.setJobName("Project32 Job1"); 
     	    j1.setJarByClass(Project32.class); 
	    ...
	    //Mapper input and output 
           ...
           j1.setOutputValueClass(ArrayWritable.class); 
	...
	Job j2 = new Job(conf); 
     	j2.setJobName("Project32 Job2"); 
     	J2.setJarByClass(Project32.class); 
	...
	//Mapper input and output 
           ...
           j2.setOutputValueClass(ArrayWritable.class); 
